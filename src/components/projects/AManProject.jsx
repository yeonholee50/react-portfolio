  ...
  const financialRules = [
    ...
    },
    {
      ...
      content: [
        ...
        '💎 General Savings Account (Fidelity): Savings in SGOV (for spending) - MAX CAP: $30,000',
    ...
    },
    {
      ...
      content: [
        ...
        '   • 20% → General Savings Account (Fidelity) (buy SGOV)',
        '',
  ...
  const IntelligenceGraphComponent = ({ onClose }) => {
    ...
    const nodes = useMemo(() => {
      ...
      { 
        ...
        data: { label: 'General Savings Account (Fidelity) (20%)\nSGOV' },
        style: { 
          background: '#1a1a00', 
          color: '#FFB81C', 
