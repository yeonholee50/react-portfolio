...
const AManProject = () => {
  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🚨 High Volatility Bank Insurance Reserve: FIRST emergency fund to deplete. Composition: 50% SGOV, 25% IBIT, 25% ETHA. Market cap: $100. Depleted FIRST in emergencies. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🚨 High Volatility Bank Insurance Reserve: FIRST emergency fund - $100 cap (50% SGOV, 25% IBIT, 25% ETHA) - depleted FIRST',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. High Volatility Bank Insurance Reserve - FIRST emergency fund (50% SGOV, 25% IBIT, 25% ETHA - $100 cap) - DEPLETE FIRST',
  ...
  const renderSignature = () => {
    const dates = {
      social: {
        signed: "November 13, 2025 at 12:00 PM EST",
        effective: "November 13, 2025 at 12:00 PM EST"
      },
      physical: {
        signed: "November 13, 2025 at 12:00 PM EST",
        effective: "November 13, 2025 at 12:00 PM EST"
