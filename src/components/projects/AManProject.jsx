  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🛡️ Fundamental Bank Insurance Reserve: Backup after Cash Reserve depleted. Composition: 90% SGOV, 10% BAR. Market cap: $1,000. Fund when excess in Charles Schwab or over $7,500 in Bank of America. Used ONLY after Cash Reserve is 100% deployed during sustained market crashes AND after Secondary Reserve is depleted.',
        '🚨 Secondary Bank Insurance Reserve: Emergency fund. Market cap: $1,000. Held in SPAXX (highly liquid). Used ONLY after Fundamental Reserve is depleted. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🛡️ Fundamental Reserve: $1,000 cap - 90% SGOV, 10% BAR',
        '🚨 Secondary Reserve: $1,000 cap (100% SPAXX)',
    ...
    },
    {
      ...
      content: [
        ...
        '',
        '🛡️ Fundamental Bank Insurance Reserve Deployment (90% SGOV, 10% BAR):',
        '   • Used ONLY after Secondary Reserve ($1,000 SPAXX) depleted',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. Secondary Bank Insurance Reserve (100% SPAXX - $1,000 cap)',
        '   2. Fundamental Bank Insurance Reserve (90% SGOV, 10% BAR - $1,000 cap)',
        ...
        '   • Market cap: $1,000 (90% SGOV, 10% BAR)',
        '   • Once funded, NEVER touch until after Secondary Reserve depleted',
        '',
