  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund to deplete. Composition: 80% SGOV, 10% GLDM, 10% IBIT. Market cap: $100. Depleted FIRST in emergencies. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund - $100 cap (80% SGOV, 10% GLDM, 10% IBIT) - depleted FIRST',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. HV Bank Insurance Reserve - FIRST emergency fund (80% SGOV, 10% GLDM, 10% IBIT - $100 cap) - DEPLETE FIRST',
        ...
        '   • Market cap: $100 (80% SGOV, 10% GLDM, 10% IBIT)',
