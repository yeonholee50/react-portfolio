  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🛡️ Fundamental Bank Insurance Reserve: PRIMARY emergency fund. Composition: 90% SGOV, 10% BAR. Market cap: $2,000. Fund when excess in Charles Schwab or over $7,500 in Bank of America. NOT for investment - strictly for emergencies only.',
        '🚨 Secondary Bank Insurance Reserve: SECONDARY emergency fund. Market cap: $1,000. Held in SPAXX (highly liquid). Depleted FIRST in emergencies, then Fundamental. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🛡️ Fundamental Reserve: PRIMARY emergency fund - $2,000 cap - 90% SGOV, 10% BAR',
        '🚨 Secondary Reserve: SECONDARY emergency fund - $1,000 cap (100% SPAXX) - depleted FIRST',
    ...
    },
    {
      ...
      content: [
        ...
        '   • Fundamental Reserve ($2,000): PRIMARY emergency fund - NOT for market deployment',
        '   • Secondary Reserve ($1,000): SECONDARY emergency fund - NOT for market deployment',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. Secondary Bank Insurance Reserve - SECONDARY emergency fund (100% SPAXX - $1,000 cap) - DEPLETE FIRST',
        '   2. Fundamental Bank Insurance Reserve - PRIMARY emergency fund (90% SGOV, 10% BAR - $2,000 cap) - DEPLETE SECOND',
        ...
        '   • Market cap: $2,000 (90% SGOV, 10% BAR)',
        '   • This is PRIMARY emergency fund - for life emergencies ONLY',
        '',
        '💡 When to Fund Secondary Reserve:',
        '   • Fund as backup after Fundamental Reserve is maxed',
        '   • Market cap: $1,000 (100% SPAXX)',
        '   • This is SECONDARY emergency fund - depleted FIRST in emergencies',
        '',
