  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🎯 Fidelity Brokerage Account: Primary investment account. Contains all stock investments (Tech, Robotics, Artificial Intelligence Investments, ETFs).',
        '📊 Cash Reserve (Fidelity): Market crash deployment fund. Composition: 90% SGOV, 10% BAR. ONLY used when market crashes (VIX-based triggers). Deploys in specific ratios: 5% Artificial Intelligence Investments, 30% Tech, 15% Robotics, 50% ETFs. NO CAP - build as much as desired.',
    ...
    },
    {
      ...
      content: [
        ...
        '   • Requirements: >$100B market cap, reputable names, undervalued robotics companies',
        ...
        '',
        '🤖 5% Artificial Intelligence Investments:',
        '   • Only invest in AI companies we believe are undervalued with market cap ≥ $50B',
        '   • Focus on high-quality AI leaders trading below intrinsic value; allocate opportunistically based on relative undervaluation',
    ...
    },
    {
      ...
      content: [
        ...
        '   4. Artificial Intelligence Investments (already have 3-month hold)',
  ...
  const IntelligenceGraphComponent = ({ onClose }) => {
    ...
    const nodes = useMemo(() => {
      ...
      { 
        ...
        data: { label: 'Artificial Intelligence Investments 5%' },
        style: { 
          background: '#111', 
          color: '#E5E5E5', 
          border: '1px solid #E5E5E5', 
  ...
  const renderSignature = () => {
    const dates = {
      social: {
        ...
        effective: "November 1, 2025 at 10:00 PM EST"
      },
      physical: {
        signed: "October 31, 2025 at 10:00 PM EST",
        effective: "November 1, 2025 at 10:00 PM EST"
