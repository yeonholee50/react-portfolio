  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund to deplete. Composition: 100% SGOV. Market cap: $100. Depleted FIRST in emergencies. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund - $100 cap (100% SGOV) - depleted FIRST',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. HV Bank Insurance Reserve - FIRST emergency fund (100% SGOV - $100 cap) - DEPLETE FIRST',
