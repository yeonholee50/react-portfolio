...
const AManProject = () => {
  ...
  const financialRules = [
    {
      ...
      content: [
        '💰 Bank of America Checking: Daily expenses & buffer. MAX CAP: $5,000. Once exceeded, split 80% to Fidelity Brokerage, 20% to General Savings Account (Charles Schwab).',
        '🎯 Fidelity Brokerage Account: Primary investment account. Contains all stock investments (Tech, Robotics, Speculative Investments, ETFs).',
        '📊 Cash Reserve (Fidelity): Market crash deployment fund. Composition: 90% SGOV, 10% BAR. ONLY used when market crashes (VIX-based triggers). Deploys in specific ratios: 5% Speculative Investments, 30% Tech, 15% Robotics, 50% ETFs. NO CAP - build as much as desired.',
    ...
    },
    {
      ...
      content: [
        ...
        '   • Requirements: Market cap above $1 trillion, companies we believe will become dominant players in the tech field',
        '   • Current holdings: GOOGL, GOOG, TSM',
        '   • 🔒 HOLD FOREVER - never sell these positions',
        '',
        '   🎯 [Google (GOOGL/GOOG)]:',
        '   • Market Cap: >$1.5T - Meets trillion-dollar requirement',
        '   • Dominant Search Engine: ~90% global search market share, capturing billions of queries daily',
        '   • Cloud Growth: Google Cloud Platform is rapidly growing #3 in cloud, competing with AWS and Azure',
        '   • AI Leadership: Gemini AI models, DeepMind breakthrough research, TensorFlow ecosystem',
        '   • YouTube: World\'s largest video platform with massive advertising revenue and creator economy',
        '   • Android: Dominates mobile OS market with billions of active devices',
        '   • Data Advantage: Unparalleled data collection enabling superior AI training and advertising targeting',
        '   • Multiple Moats: Search, cloud, mobile OS, video platform, AI research - creates compounding competitive advantages',
        '',
        '   🎯 [TSM (Taiwan Semiconductor)]:',
        '   • Market Cap: >$800B - Approaching trillion-dollar threshold, critical infrastructure player',
        '   • Global Chip Leader: World\'s largest semiconductor foundry, manufactures chips for virtually all major tech companies',
        '   • Monopolistic Moat: Advanced process nodes (3nm, 5nm) - only company capable of mass-producing cutting-edge chips',
        '   • Apple/Nvidia Supplier: Exclusive supplier for Apple\'s A-series chips and major supplier for Nvidia GPUs',
        '   • Strategic Position: Taiwan\'s geopolitical importance + technical expertise = irreplaceable infrastructure',
        '   • Future Technologies: Leading in advanced packaging, AI chips, automotive semiconductors',
        '   • Pricing Power: Limited competition at leading edge gives TSM significant pricing leverage',
        '   • Foundry Model: Captures value from entire tech industry - every major advancement requires TSM manufacturing',
        '',
        '🤖 15% Robotics Investments:',
        '   • Requirements: Companies must be major players in robotics and we believe are well positioned to become dominant players in the robotics field',
        '   • Companies must already use robotics in their daily operations',
        '   • Focus on high-quality robotics leaders trading below intrinsic value; allocate opportunistically based on relative undervaluation',
        '   • 🔒 HOLD FOREVER - never sell unless fundamentals break',
        '',
        '   🎯 [Amazon (AMZN)]:',
        '   • Robotics in Daily Operations: Over 750,000+ mobile robots deployed in fulfillment centers worldwide',
        '   • Automation Scale: Largest fleet of warehouse robots globally - Kiva Systems acquisition transformed logistics',
        '   • Efficiency Gains: Robotics reduces fulfillment costs, enables same-day/next-day delivery at scale',
        '   • Future Expansion: Autonomous delivery drones (Prime Air), last-mile delivery robots (Scout), warehouse automation',
        '   • AWS & Robotics: Cloud infrastructure powers robotics development and AI/ML for autonomous systems',
        '   • Competitive Moat: Robotics expertise creates massive cost advantages in e-commerce and logistics',
        '   • Strategic Position: As robotics becomes mainstream, Amazon\'s early investments position them as industry leader',
        '   • Vertical Integration: Owns entire stack from robot manufacturing to deployment to optimization',
        '',
        '   💡 Other Potential Holdings:',
        '   • Consider smaller robotics companies (<$100B) that are leaders in specialized robotics segments',
        '   • Industrial automation, medical robotics, autonomous vehicles, or service robotics companies',
        '   • Must demonstrate real-world deployment and clear path to market leadership',
        '',
    ...
    },
    {
      ...
      content: [
        ...
        '   6. Robotics Investments',
        '   7. Technology investments (GOOGL, GOOG, TSM)',
        '   8. ETFs (core holdings)',
        '   9. ☢️ NUCLEAR OPTION: Roth IRA (penalty + lost contribution space)',
        '',
        ...
        '   • Market cap: $100 (50% SGOV, 10% GLDM, 20% IBIT, 20% ETHA)',
        ...
        '',
        '🚨 CRITICAL: Emergency Reserves Usage:',
        ...
        '',
        '❌ INVALID Reasons (Use General Savings Account instead):',
  ...
  const IntelligenceGraphComponent = ({ onClose }) => {
    ...
    const nodes = useMemo(() => {
      ...
      { 
        ...
        data: { label: 'Robotics Investments 15%' },
        style: { 
          background: '#111', 
          color: '#E5E5E5', 
          border: '1px solid #E5E5E5', 
      ...
      { 
        ...
        data: { label: 'Speculative Investments 5%' },
        style: { 
          background: '#111', 
          color: '#E5E5E5', 
          border: '1px solid #E5E5E5', 
  ...
  const renderSignature = () => {
    const dates = {
      social: {
        signed: "October 31, 2025 at 10:00 PM EST",
        effective: "November 2, 2025 at 10:00 PM EST"
      },
      physical: {
        signed: "October 31, 2025 at 10:00 PM EST",
        effective: "November 2, 2025 at 10:00 PM EST"
