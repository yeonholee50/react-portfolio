...
const AManProject = () => {
  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🎯 Fidelity Brokerage Account: Primary investment account. Contains all stock investments (Tech, Healthcare, Artificial Intelligence Investments, ETFs).',
        '📊 Cash Reserve (Fidelity): Market crash deployment fund. Composition: 90% SGOV, 10% BAR. ONLY used when market crashes (VIX-based triggers). Deploys in specific ratios: 5% Artificial Intelligence Investments, 30% Tech, 15% Healthcare, 50% ETFs. NO CAP - build as much as desired.',
  ...
  const renderSignature = () => {
    const dates = {
      social: {
        signed: "October 30, 2025 at 10:00 PM EST",
        effective: "October 30, 2025 at 10:00 PM EST"
      },
      physical: {
        signed: "October 30, 2025 at 10:00 PM EST",
        effective: "October 30, 2025 at 10:00 PM EST"
