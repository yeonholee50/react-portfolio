  ...
  const financialRules = [
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund to deplete. Composition: 50% SGOV, 10% GLDM, 20% IBIT, 20% ETHA. Market cap: $100. Depleted FIRST in emergencies. NEVER touch unless absolute emergency.',
        ...
        '💎 Secondary Bank Insurance Reserve: SECONDARY emergency fund. Composition: 100% SGOV. Market cap: $300. Depleted SECOND in emergencies, after HV Reserve, then Fundamental. NEVER touch unless absolute emergency.',
    ...
    },
    {
      ...
      content: [
        ...
        '🚨 HV Bank Insurance Reserve: FIRST emergency fund - $100 cap (50% SGOV, 10% GLDM, 20% IBIT, 20% ETHA) - depleted FIRST',
    ...
    },
    {
      ...
      content: [
        ...
        '   1. HV Bank Insurance Reserve - FIRST emergency fund (50% SGOV, 10% GLDM, 20% IBIT, 20% ETHA - $100 cap) - DEPLETE FIRST',
        ...
        '   4. Secondary Technology Investments (already have 3-month hold)',
        ...
        '',
        '💡 When to Fund HV Bank Insurance Reserve:',
        ...
        '   • Fund as backup after HV Bank Insurance Reserve is maxed',
